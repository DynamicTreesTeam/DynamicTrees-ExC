...
import maxhyper.dynamictreescorvus.worldgen.BiomeDataBasePopulator;
...
@Mod.EventBusSubscriber(modid = DynamicTreesCorvus.MODID)
@ObjectHolder(DynamicTreesCorvus.MODID)
public class ModContent {
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event) {
		...
		treeBlocks.addAll(LeavesPaging.getLeavesMapForModId(DynamicTreesCorvus.MODID).values());
	...
	public static void registerModels(ModelRegistryEvent event) {
		...
		LeavesPaging.getLeavesMapForModId(DynamicTreesCorvus.MODID).forEach((key, leaves) -> ModelLoader.setCustomStateMapper(leaves, new StateMap.Builder().ignore(BlockLeaves.DECAYABLE).build()));
	}
}
