package maxhyper.dynamictreestechreborn.dropcreators;
...
public class DropCreatorFruit extends DropCreator {
	...
	public DropCreatorFruit(ItemStack fruitStack) {
		super(new ResourceLocation(DynamicTreesTechReborn.MODID, fruitStack.getItem().getRegistryName().getResourcePath()));
