...
import maxhyper.dynamictreessugiforest.trees.*;
import maxhyper.dynamictreessugiforest.worldgen.BiomeDataBasePopulator;
...
@ObjectHolder(DynamicTreesSugiForest.MODID)
public class ModContent {

	public static ILeavesProperties sugiLeavesProperties;
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event) {
		...
		treeBlocks.addAll(LeavesPaging.getLeavesMapForModId(DynamicTreesSugiForest.MODID).values());
	...
	public static void setUpSeedRecipes (String name, ItemStack treeSapling){
		Species treeSpecies = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesSugiForest.MODID, name));
	...
	public static void registerModels(ModelRegistryEvent event) {
		...
		LeavesPaging.getLeavesMapForModId(DynamicTreesSugiForest.MODID).forEach((key, leaves) -> ModelLoader.setCustomStateMapper(leaves, new StateMap.Builder().ignore(BlockLeaves.DECAYABLE).build()));
	}
}
