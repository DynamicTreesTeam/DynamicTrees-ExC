package maxhyper.dynamictreessugiforest.dropcreators;
...
public class DropCreatorResin extends DropCreator {
	...
	public DropCreatorResin(ItemStack resinStack) {
		super(new ResourceLocation(DynamicTreesSugiForest.MODID, resinStack.getItem().getRegistryName().getResourcePath()));
