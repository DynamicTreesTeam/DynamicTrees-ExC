...
import maxhyper.dynamictreesexc.compat.CompatInit;
...
//		}
	...
	public void init() {
		if (Loader.isModLoaded("integrateddynamics")) {
			CompatInit.initIntegratedDynamics();
		}
		if (Loader.isModLoaded("tconstruct")) {
			CompatInit.initTinkersConstruct();
		}
		if (Loader.isModLoaded("thaumicbases")) {
			CompatInit.initThaumicBases();
		}
	...
	public void postInit() {
		if (Loader.isModLoaded("thaumicbases")) {
			CompatInit.postInitThaumicBases();
		}
	}
