...
public class DynamicTreesExC {
	...
	public static final String DEPENDENCIES = "required-after:" + ModConstants.DYNAMICTREES_LATEST + ";after:quark"+ ";after:integrateddynamics"+ ";after:tconstruct"+ ";after:techreborn"+ ";after:thaumcraft"+ ";after:thaumicbases"+ ";after:extrautils2";
