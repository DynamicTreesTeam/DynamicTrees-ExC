...
@Mod(modid= DynamicTreesTechReborn.MODID, name= DynamicTreesTechReborn.NAME, dependencies = DynamicTreesTechReborn.DEPENDENCIES, updateJSON = "https://github.com/supermassimo/DynamicTrees-ExC/blob/1.12.2/.DONE/DynamicTrees-TechReborn/version_info.json?raw=true")
