package maxhyper.dynamictreesforbiddenarcanus.dropcreators;
...
public class DropCreatorFruit extends DropCreator {
	...
	public DropCreatorFruit(ItemStack seedStack) {
		super(new ResourceLocation(DynamicTreesForbiddenArcanus.MODID, Objects.requireNonNull(seedStack.getItem().getRegistryName()).getResourcePath()));
