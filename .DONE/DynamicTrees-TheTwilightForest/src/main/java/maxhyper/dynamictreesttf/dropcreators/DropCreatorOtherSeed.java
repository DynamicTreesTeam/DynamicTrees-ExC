package maxhyper.dynamictreesttf.dropcreators;
...
public class DropCreatorOtherSeed extends DropCreator {
	...
	public DropCreatorOtherSeed(ItemStack fruitStack) {
		super(new ResourceLocation(DynamicTreesTTF.MODID, fruitStack.getItem().getRegistryName().getResourcePath()));
