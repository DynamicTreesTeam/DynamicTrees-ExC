...
public class BlockBranchMagicCore extends BlockBranchTwilight {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (!placedCritter){
            worldIn.setBlockState(pos, switchedBlock.getDefaultState().withProperty(BlockDynamicTwilightRoots.RADIUS, worldIn.getBlockState(pos).getValue(BlockDynamicTwilightRoots.RADIUS)));
        }
        return true;
    }
