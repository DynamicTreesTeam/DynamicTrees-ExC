...
public class TreeAshen extends TreeFamily {
    ...
    public class SpeciesAshen extends Species {

        SpeciesAshen(TreeFamily treeFamily) {
            super(treeFamily.getName(), treeFamily, ModContent.ashenLeavesProperties);
    ...
    public void createSpecies() {
        setCommonSpecies(new SpeciesAshen(this));
    }
