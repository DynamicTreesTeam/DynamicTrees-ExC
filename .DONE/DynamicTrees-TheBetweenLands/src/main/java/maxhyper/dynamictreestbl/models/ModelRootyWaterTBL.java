...
public class ModelRootyWaterTBL implements IBakedModel {
    ...
    public ModelRootyWaterTBL(IBakedModel rootsModel, String stillWater, String flowingWater) {
        this.rootsModel = rootsModel;
        this.stillWaterTexture = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(stillWater);
        this.flowWaterTexture = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(flowingWater);
    }
