...
public class DynamicSlimeIslandGenerator implements IWorldGenerator {
    ...
    public DynamicSlimeIslandGenerator() {
        ...
        treeGenBlue = new DynamicSlimeTreeGenerator(DynamicSlimeTreeGenerator.slimeType.BLUE, 1);
        treeGenPurple = new DynamicSlimeTreeGenerator(DynamicSlimeTreeGenerator.slimeType.PURPLE, 1);
    ...
    protected void generateIslandInChunk(long seed, World world, int chunkX, int chunkZ) {
        ...
        DynamicSlimeTreeGenerator treeGen = treeGenPurple; // purple trees on blue/green islands
            ...
            for(int z = 0; z <= zRange; z++) {
                for(int y = 0; y <= erode_height; y++) {
                    ...
                    for(BlockPos pos : new BlockPos[]{pos1, pos2}) {
                        ...
                        if (world.getBlockState(pos) == dirt || world.getBlockState(pos) == grass){
