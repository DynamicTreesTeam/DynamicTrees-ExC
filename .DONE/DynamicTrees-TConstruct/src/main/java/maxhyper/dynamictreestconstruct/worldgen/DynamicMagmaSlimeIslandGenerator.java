...
public class DynamicMagmaSlimeIslandGenerator extends DynamicSlimeIslandGenerator {
    ...
    public DynamicMagmaSlimeIslandGenerator() {
        ...
        treeGenMagma = new DynamicSlimeTreeGenerator(DynamicSlimeTreeGenerator.slimeType.MAGMA, 1);
