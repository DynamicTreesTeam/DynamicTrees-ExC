...
public class BakedModelBlockPalmFrondsBig implements IBakedModel {
    ...
    public BakedModelBlockPalmFrondsBig(ResourceLocation frondRes, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
