...
@Mod(modid= DynamicTreesMysticalWorld.MODID, name= DynamicTreesMysticalWorld.NAME, dependencies = DynamicTreesMysticalWorld.DEPENDENCIES, updateJSON = "https://github.com/supermassimo/DynamicTrees-ExC/tree/1.12.2/.DONE/DynamicTrees-MysticalWorld/version_info.json?raw=true")
