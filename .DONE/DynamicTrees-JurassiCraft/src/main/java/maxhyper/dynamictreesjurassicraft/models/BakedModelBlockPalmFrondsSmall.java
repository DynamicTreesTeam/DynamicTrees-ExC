...
public class BakedModelBlockPalmFrondsSmall implements IBakedModel {
    ...
    public BakedModelBlockPalmFrondsSmall(ResourceLocation frondRes, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
            ...
            for (int pass = 0; pass < 3; pass++) {
                for (int half = 0; half < 2; half++) {
                    ...
                    for (int v = 0; v < 8; v++) {
                        ...
                        angle += Math.PI * ((pass == 2 ? 0.18 : pass == 1 ? 0.06 : -0.09) );// + 0.1*rand.nextFloat());
                        angle -= (surr.ordinal() % 0.13) * (3-pass);
                        ...
                        angle -= ((surr.ordinal()* (3-pass)) % 0.17);
                        x = (float) (Math.sin(angle) * len);
                        z = (float) (Math.cos(angle) * len);
                        ...
                        x += 0.5f;
                        z += 0.5f;
                        y += pass == 2 ? -0.225 : pass == 0 ? 0.125 : 0.225;
                        y += 0.25f;
