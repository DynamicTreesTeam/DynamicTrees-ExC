...
public class ModelLoaderBlockPalmFronds extends ModelLoaderGeneric {
    ...
    private final int frondSize;

    public ModelLoaderBlockPalmFronds(String code, int size) {
        super(code, new ResourceLocation(DynamicTreesJurassiCraft.MODID, "block/smartmodel/dynamicpalmfronds"));
        frondSize = size;
    }
    ...
    protected IModel loadModel(ResourceLocation resourceLocation, ModelBlock baseModelBlock) {
        return new ModelBlockPalmFronds(baseModelBlock, frondSize);
    }
