...
public class BlockDynamicHearthgroveRoots extends Block implements ITreePart {// ,MimicProperty.IMimic {
    ...
    public BlockDynamicHearthgroveRoots() {
...
//    }
    ...
    public void onBlockDestroyedByPlayer(World world, BlockPos pos, IBlockState state) {
        ...
        world.setBlockState(pos, ModContent.hearthgroveBranch.getDefaultState().withProperty(RADIUS, state.getValue(RADIUS)));
    }
