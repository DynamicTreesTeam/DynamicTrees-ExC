package maxhyper.dynamictreessimplytea.dropcreators;
...
public class DropCreatorFruit extends DropCreator {
	...
	public DropCreatorFruit(ItemStack fruitStack) {
		super(new ResourceLocation(DynamicTreesSimplyTea.MODID, fruitStack.getItem().getRegistryName().getResourcePath()));
