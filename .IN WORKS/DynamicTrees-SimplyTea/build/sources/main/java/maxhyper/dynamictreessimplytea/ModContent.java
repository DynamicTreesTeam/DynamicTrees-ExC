...
import maxhyper.dynamictreessimplytea.trees.*;
import maxhyper.dynamictreessimplytea.worldgen.BiomeDataBasePopulator;
...
@Mod.EventBusSubscriber(modid = DynamicTreesSimplyTea.MODID)
@ObjectHolder(DynamicTreesSimplyTea.MODID)
public class ModContent {

	public static ILeavesProperties teaLeavesProperties;
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event) {
		...
		LeavesPaging.getLeavesBlockForSequence(DynamicTreesSimplyTea.MODID, 0, teaLeavesProperties); //leaves5 - 2
		...
		treeBlocks.addAll(LeavesPaging.getLeavesMapForModId(DynamicTreesSimplyTea.MODID).values());
	...
	public static void setUpSeedRecipes (String name, ItemStack treeSapling){
		Species treeSpecies = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesSimplyTea.MODID, name));
	...
	public static void registerModels(ModelRegistryEvent event) {
		...
		LeavesPaging.getLeavesMapForModId(DynamicTreesSimplyTea.MODID).forEach((key, leaves) -> ModelLoader.setCustomStateMapper(leaves, new StateMap.Builder().ignore(BlockLeaves.DECAYABLE).build()));
