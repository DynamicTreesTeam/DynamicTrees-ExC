package maxhyper.dynamictreestheaether2.dropcreators;
...
public class DropCreatorFruit extends DropCreator {
	...
	public DropCreatorFruit(ItemStack fruitStack) {
		super(new ResourceLocation(DynamicTreesTheAether2.MODID, fruitStack.getItem().getRegistryName().getResourcePath()));
