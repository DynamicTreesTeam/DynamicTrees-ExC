package maxhyper.dynamictreesfossil.dropcreators;
...
public class DropCreatorFruit extends DropCreator {
	...
	public DropCreatorFruit(ItemStack fruitStack) {
		super(new ResourceLocation(DynamicTreesFossil.MODID, fruitStack.getItem().getRegistryName().getResourcePath()));
