...
//        maple = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "maple"));
//        silverbell = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "silverbell"));
//        amaranth = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "amaranth"));
//        tigerwood = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "tigerwood"));
//        hopseed = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "hopseed"));
//        willow = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "willow"));
//        sakura = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "sakura"));
//        eucalyptus = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "eucalyptus"));
//        ghostwood = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "ghostwood"));
//        bloodwood = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "bloodwood"));
//        fusewood = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "fusewood"));
//        darkwood = TreeRegistry.findSpecies(new ResourceLocation(DynamicTreesForestry.MODID, "darkwood"));
//    }
//
