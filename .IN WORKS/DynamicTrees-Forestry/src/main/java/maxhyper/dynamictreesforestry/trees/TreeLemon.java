...
public class TreeLemon extends TreeFamily {
    ...
    public class SpeciesLemon extends Species {
        ...
        SpeciesLemon(TreeFamily treeFamily) {
            ...
            addGenFeature(new FeatureGenFruitLeaves(6, 8, ModContent.lemonLeavesProperties.getDynamicLeavesState(), ModContent.fruitLemonLeavesProperties.getDynamicLeavesState(), 0.1f));
    ...
    public TreeLemon() {
        super(new ResourceLocation(DynamicTreesForestry.MODID, "lemon"));
