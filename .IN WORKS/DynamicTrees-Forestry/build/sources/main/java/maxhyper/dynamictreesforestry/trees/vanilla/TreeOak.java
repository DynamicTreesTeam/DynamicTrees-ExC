...
public class TreeOak extends TreeFamily {
    ...
    public class SpeciesOak extends Species {
        ...
        SpeciesOak(TreeFamily treeFamily) {
            ...
            addGenFeature(new FeatureGenFruitLeaves(8, 10, ModContent.oakLeavesProperties.getDynamicLeavesState(), ModContent.fruitAppleLeavesProperties.getDynamicLeavesState(), 0.1f));
    ...
    public TreeOak() {
        super(new ResourceLocation(DynamicTreesForestry.MODID, "oak"));
