package maxhyper.dynamictreesjurassicraft.dropcreators;
...
public class DropCreatorResin extends DropCreator {
	...
	public DropCreatorResin(ItemStack resinStack) {
		super(new ResourceLocation(DynamicTreesJurassiCraft.MODID, resinStack.getItem().getRegistryName().getResourcePath()));
