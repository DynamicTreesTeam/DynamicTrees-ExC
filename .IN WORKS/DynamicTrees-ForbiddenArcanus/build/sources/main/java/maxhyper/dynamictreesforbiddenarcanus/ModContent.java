...
public class ModContent {
	...
	public static BlockFruit blockGoldenApple;
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event) {
		...
		cherrywoodLeavesProperties = setUpLeaves(FnATreeCherrywood.leavesBlock, "acacia");
		mysterywoodLeavesProperties = setUpLeaves(FnATreeMysterywood.leavesBlock, "deciduous");
		LeavesPaging.getLeavesBlockForSequence(DynamicTreesForbiddenArcanus.MODID, 0, cherrywoodLeavesProperties); //leaves5 - 0
		LeavesPaging.getLeavesBlockForSequence(DynamicTreesForbiddenArcanus.MODID, 1, mysterywoodLeavesProperties); //leaves5 - 1
